...
int main() {
	...
	cout << "hit left right button to drive a car! press break to close" << endl;
	...
	while (breakLoop == false) {
		...
		case 108: { // l -->  pressed left
			car->setPosition(-1);
			break;
		}
		case 99: { // c --> pressed center
			car->setPosition(0);
			break;
		}
		case 114: { // r --> pressed right
			car->setPosition(1);
			break;
		}
		case 98: { // b --> pressed break
			breakLoop = true;
			break;
		}
		default: {
